		...
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#f6f6f6","height":"auto"}'>
			...
			<view class="uni-product-list" :style='{"padding":"24rpx","margin":"24rpx 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"border":"2rpx solid #f7de91","boxShadow":"0 4rpx 8rpx rgba(182,158,18,.4),inset 0px 0px 64rpx 0px #ffef92","padding":"0px 0 24rpx 0","margin":"0 0 32rpx","backgroundColor":"#fff","borderRadius":"24rpx","flexWrap":"wrap","display":"flex","width":"48%","position":"relative","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"padding":"4rpx 20rpx","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","width":"96%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"2"}'>{{product.yonghuxingming}}</view>
					<image :style='{"padding":"0","margin":"48rpx auto 8rpx","objectFit":"cover","borderRadius":"100%","display":"block","width":"260rpx","height":"260rpx"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.touxiang)" :src="product.touxiang.split(',')[0]"></image>
					<image :style='{"padding":"0","margin":"48rpx auto 8rpx","objectFit":"cover","borderRadius":"100%","display":"block","width":"260rpx","height":"260rpx"}' mode="aspectFill" class="uni-product-image" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
