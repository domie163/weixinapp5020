<template>
	<view class="content">
		<view :style='{"minHeight":"100vh","width":"100%","padding":"0 0 132rpx","position":"relative","background":"url(http://codegen.caihongy.cn/20221112/9b019ed355d24c3e88b63a5ad0170d87.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20221112/e866eac60553442587c2b20f0b4f151b.png) no-repeat right bottom,#fdfaf0","height":"auto"}'>
			<view :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px #eee","margin":"0 0 20rpx 0","background":"url(http://codegen.caihongy.cn/20221112/286392d539b94f04bcf52c9a98e1d573.png) no-repeat right top,#fdfaf0","display":"flex","width":"100%","backgroundSize":"200rpx auto","height":"280rpx"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
			...
			<view :style='{"padding":"0 24rpx 160rpx","margin":"0 24rpx","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 48rpx)","height":"auto"}' class="list">
				...
				<view @tap="onPageTap('../chat/chat')" :style='{"borderColor":"#ccc","alignItems":"center","borderWidth":"2rpx 0 0","display":"flex","width":"100%","lineHeight":"80rpx","borderStyle":"dashed","height":"auto"}' class="li" hover-class="hover">
					<view v-if="true" :style='{"width":"64rpx","lineHeight":"64rpx","fontSize":"64rpx","color":"#FFC618"}' class="cuIcon-service"></view>
					<view class="text" :style='{"width":"100%","padding":"0 20rpx","lineHeight":"88rpx","fontSize":"28rpx","color":"#333","flex":"1"}'>反馈信息</view>
					<view v-if="true" :style='{"width":"28rpx","lineHeight":"28rpx","fontSize":"28rpx","color":"#999"}' class="cuIcon-right"></view>
				</view>
