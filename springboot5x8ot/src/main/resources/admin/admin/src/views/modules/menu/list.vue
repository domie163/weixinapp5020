			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"2px solid #FFD6A2","cursor":"pointer","padding":"0 10px","margin":"0 4px 5px 0","outline":"none","color":"#f4bc75","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('menu','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"2px solid #FFD6A2","cursor":"pointer","padding":"0 10px","margin":"0 4px 5px 0","outline":"none","color":"#f4bc75","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('menu','编辑名称')" type="primary" size="mini" @click="updateMenuNamePage(scope.row)">编辑名称</el-button>
							<el-button :style='{"border":"2px solid #FFD6A2","cursor":"pointer","padding":"0 10px","margin":"0 4px 5px 0","outline":"none","color":"#f4bc75","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('menu','编辑父级')" type="primary" size="mini" @click="updateMenuLevelPage(scope.row)">编辑父级</el-button>
							<el-button :style='{"border":"2px solid #FFD6A2","cursor":"pointer","padding":"0 10px","margin":"0 4px 5px 0","outline":"none","color":"#f4bc75","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('menu','删除')" type="danger" size="mini" @click="deleteMenu(scope.row)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
