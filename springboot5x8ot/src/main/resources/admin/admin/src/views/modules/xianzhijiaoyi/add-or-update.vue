	...
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="select" v-if="type!='info'"  label="物品分类" prop="wupinfenlei">
				...
				<el-form-item :style='{"width":"100%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-if="type!='info'"  label="物品详情" prop="wupinxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.wupinxiangqing" label="物品详情" prop="wupinxiangqing">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.wupinxiangqing = this.ruleForm.wupinxiangqing.replace(reg,'../../../springboot5x8ot/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
