<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="发布类型" prop="fabuleixing">
					<el-input v-model="ruleForm.fabuleixing" placeholder="发布类型" clearable  :readonly="ro.fabuleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="发布类型" prop="fabuleixing">
					<el-input v-model="ruleForm.fabuleixing" placeholder="发布类型" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huzhufabuleixing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huzhufabuleixingCrossAddOrUpdateFlag = false;
						 this.parent.search();
